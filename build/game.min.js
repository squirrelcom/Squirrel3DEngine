...
e)Math.random()<1/++n&&(t=r);return e[t]}function randElem(e){return e[Math.random()*e.length|0]}function rand(e,t){return e+Math.floor(Math.random()*(t-e+1))}function randf(e,t){return e+Math.random()*(t-e)}function Dungeon(e,t,n){function f(t,n,i,s){return function(a,f){s||(s={});var l,c=s.mass||0;s.character&&(c=1e5);var h=1;s.randScale&&(h+=randf(-s.randScale,s.randScale),c*=h),a.boundingBox||a.computeBoundingBox();for(var p=0;p<f.length;++p)fixAnisotropy(f[p]);var d=f.length>1?new THREE.MeshFaceMaterial
(f):f[0];if(s.collision){var v=Physijs.createMaterial(d,.7,.2);if(s.collision=="plane")l=new Physijs.PlaneMesh(a,v,c);else if(s.collision=="box")l=new Physijs.BoxMesh(a,v,c);else if(s.collision=="sphere")l=new Physijs.SphereMesh(a,v,c);else if(s.collision=="cylinder")l=new Physijs.CylinderMesh(a,v,c);else if(s.collision=="cone")l=new Physijs.ConeMesh(a,v,c);else if(s.collision=="capsule")l=new Physijs.CapsuleMesh(a,v,c);else if(s.collision=="convex")l=new Physijs.ConvexMesh(a,v,c);else{if(s.collision!="concave"
)throw"Unsupported collision mesh type "+s.collision;l=new Physijs.ConcaveMesh(a,v,c)}r.objects.push(l)}else l=new THREE.Mesh(a,d);s.door&&(n.x=Math.floor(n.x)+.5,n.z=Math.floor(n.z)+.5),n.x*=t.gridSize,n.z*=t.gridSize,!n.y&&n.y!==0&&(n.y=.5*(a.boundingBox.max.y-a.boundingBox.min.y)+.001),l.position.copy(n),i&&(l.rotation.y=i/180*Math.PI),l.scale.set(h,h,h),!s.noShadows&&!s.animation&&(l.castShadow=!0,l.receiveShadow=!0),c===0&&!s.character&&(l.matrixAutoUpdate=!1,l.updateMatrix()),s.animation&&(l.visible=!1
,l.geometry=u,l.mesh=animationManager.createAnimatedMesh(a,f,s),s.noShadows||(l.mesh.castShadow=!0,l.mesh.receiveShadow=!0),l.add(l.mesh)),s.character&&(s.character.hp&&(l.hp=s.character.hp),l.faction=s.character.faction||1,r.monsters.push(l)),s.item&&(l.items={},l.items[s.item.type]=s.item.value||1,l.itemName=s.name),l.addEventListener("collision",function(e,t,n){if(t.lengthSq()<1)return;e.damage&&s.sound&&soundManager.playSpatial(s.sound,e.position,10);if(this.dead)return;this.hp&&e.damage&&e.position.y>.3&&
this.faction!=e.faction&&(this.hp-=e.damage,e.damage=0,this.hp<=0&&(soundManager.playSpatial("robot-death",20),this.dead=!0,this.mesh&&(this.mesh.animate=!1),this.setAngularFactor({x:1,y:1,z:1}),this.setAngularVelocity({x:0,y:0,z:0}),this.setLinearVelocity({x:0,y:0,z:0}),this.mass=2e3,this.mesh?this.mesh.material=o:this.material=o))}),e.add(l),s.character&&s.collision&&l.setAngularFactor({x:0,y:1,z:0}),s.character&&(l.speed=s.character.speed);if(s.door){l.setAngularFactor({x:0,y:1,z:0});var m=l.position.clone
(),g=.5*(a.boundingBox.max.x-a.boundingBox.min.x)-.1;m.x-=Math.cos(l.rotation.y)*g,m.z+=Math.sin(l.rotation.y)*g;var y=new Physijs.HingeConstraint(l,m,new THREE.Vector3(0,1,0));e.addConstraint(y),y.setLimits(-Math.PI/2*.95+l.rotation.y,Math.PI/2*.95+l.rotation.y,.3,.01)}}}function l(n){typeof n=="string"&&(n=JSON.parse(n)),n.map instanceof Array&&(n.map=new Map(n.width,n.depth,n.map)),t.geometry.computeBoundingBox(),t.position.x=n.start[0]*n.gridSize,t.position.y=.5*(t.geometry.boundingBox.max.y-t.geometry.boundingBox
.min.y)+.001,t.position.z=n.start[1]*n.gridSize,n.startAngle&&controls.setYAngle(n.startAngle),cache.loadModel("assets/models/gun/gun.js",function(n,r){t.rhand=new Physijs.BoxMesh(n,new THREE.MeshFaceMaterial(r)),t.rhand.ammoGood=r[2].clone(),t.rhand.ammoOut=r[2].clone(),t.rhand.ammoOut.color.setRGB(.3,.1,.1),t.rhand.castShadow=!0,t.rhand.receiveShadow=!0,t.rhand.position.set(.4,.2,-1),t.add(t.rhand),e.add(t),t.setAngularFactor({x:0,y:0,z:0})},a+"gun"),cache.loadModel("assets/models/fork/fork.js",function(t,
n){r.forks=[],r.forkIndex=0,r.forkTypes={plain:{damage:5,material:n[0]},heated:{damage:8,material:n[0].clone()},plasma:{damage:20,material:n[0].clone()}},r.forkTypes.heated.material.ambient.setRGB(1,.3,.3),r.forkTypes.plasma.material.ambient.setRGB(1,.3,1);for(var i=0;i<40;++i){var s=new Physijs.BoxMesh(t,r.forkTypes.plain.material,100);s.damage=r.forkTypes.plain.damage,r.forks.push(s),s.visible=!1,s.scale.set(3,3,1),e.add(s),s.scale.set(1,1,1)}}),r.generateMesh(n),r.addLights(n),r.addObjects(n),r.addItems(n
),r.addMonsters(n),lightManager.update(pl),r.level=n,r.grid=new PF.Grid(n.width,n.depth,n.map.getWalkableMatrix()),r.pathFinder=new PF.AStarFinder({allowDiagonal:!0,dontCrossCorners:!0,heurestic:PF.Heuristic.euclidean}),r.onLoad?r.onLoad():r.onLoad=!0,n.title&&displayMessage(n.title)}var r=this;this.onLoad=null,this.objects=[],this.monsters=[],this.grid=null,this.pathFinder=null,this.level=null;var i=new THREE.MeshBasicMaterial({color:0}),s=new THREE.MeshBasicMaterial({color:16711935}),o=new THREE.MeshLambertMaterial
